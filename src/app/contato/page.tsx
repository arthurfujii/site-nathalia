...
export default function Contato() {
  ...
  return (
    <section
      className='flex flex-col items-center justify-between gap-5 py-16'
      id='contato'
    >
      ...
      <section className='flex w-full justify-between gap-5'>
        <form className='flex w-full flex-col gap-2.5' onSubmit={handleSubmit}>
          ...
          <input
            ...
            id='name'
            placeholder='Nome'
            className='block w-full max-w-md rounded-[20px] border border-gray-500 bg-white px-5 py-2.5'
            name='nome'
          />
          ...
          <textarea
            ...
            className='h-60 w-full max-w-md resize-none rounded-[20px] border border-gray-500 bg-white px-5 py-2.5'
            name='mensagem'
          />

          <button
            type='submit'
            className='w-32 rounded-[20px] border bg-[#9785BD] px-5 py-2.5 text-white'
          >
            Enviar
          </button>
        </form>
